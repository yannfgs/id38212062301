...
interface IUsuario { // Define uma nova interface chamada 'IUsuario'.
...
class Usuario implements IUsuario { // Define uma nova classe 'Usuario' que implementa a interface 'IUsuario'.
    ...
    constructor(nome: string, idade: number) { // Construtor que aceita 'nome' e 'idade' e inicializa as propriedades da classe.
    ...
    imprimirInfo(): void { // Implementa o método 'imprimirInfo' conforme exigido pela interface 'IUsuario'.
